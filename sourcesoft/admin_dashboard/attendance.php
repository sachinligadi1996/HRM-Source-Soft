...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="#" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" class="form-control form-control-sm" name="checkin" required>
                                    </div>
                                    <div class="col-md-6">
            ...
            <?php
                        ...
                        if(isset($_POST['filter'])){
                         ...
                         $to=$_POST['to'];
                         $name=$_POST['fname'];
                         $query = mysqli_query($conn, "SELECT *, ROW_NUMBER() OVER (ORDER BY id DESC) as row_num FROM attendance WHERE emp_name='$name' AND date BETWEEN '$from' and '$to' ");
                        }
                        ?>
                                ...
                                <div>
                                    <form action="#" method="post" class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control form-control form-control-sm" name="fname"
        ...
        while ($show_emp = mysqli_fetch_array($query_show_emp)) {
        ?>
                                                <option value="<?php echo $show_emp['fname']; ?>"
                                                    data-empid="<?php echo $show_emp['empid']; ?>">
                                                    <?php echo $show_emp['fname']; ?>
                                                </option>
                                                <?php
            $i++;
        }
        ?>
                                        ...
                                        $(document).ready(function() {
                                            $('#employeeName').change(function() {
                                                var selectedEmployee = $(this).children(
                                                    "option:selected");
                                                var empid = selectedEmployee.attr(
                                                'data-empid'); // Get the selected Employee ID
                                                $('#employeeId').val(
                                                empid); // Set the value in the Employee ID input field
                                            });
                                        });
                                        </script>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a class='' href='update_attendance?id=<?php echo $result['id']; ?>'><i
                                                    class='fa fa-edit text-warning'></i></a>
                                            <a class='' href='attendance?id=<?php echo $result['id']; ?>'><i
...
if (!empty($_GET['id']) && isset($_GET['confirm']) && $_GET['confirm'] === 'true') {
    ...
    $idd = $_GET['id'];
    $query = "DELETE FROM attendance WHERE id='$idd'";
    ...
    echo "<script>
            ...
            if(confirmed) {
                window.location.href = 'attendance?id=$idd&confirm=true';
            } else {
