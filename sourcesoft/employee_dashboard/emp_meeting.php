                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable">
                                            ...
                                            while ($data = mysqli_fetch_array($query_data)) {
                                                ...
                                                $query_result = mysqli_query($conn, "SELECT *, ROW_NUMBER() OVER (ORDER BY id DESC) as row_num FROM `meeting`");
                                            ...
                                            ?>
                                                    ...
                                                    <th scope="row"><?php echo $serialNumber; ?></th>
                                                        ...
                                                        <td><a target="_blank" href="<?php echo $result['link']; ?>"><?php echo $result['link']; ?></a></td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="#" method="POST">
                                    <div class="col-md-6">
                                        <label for="inputemail" class="form-label">Meeting Organiser</label>
                                        <input type="text" class="form-control form-control-sm" name="fname_" id="" placeholder="Add Link" value="<?php echo $fname; ?> " disabled>
                                        <input type="hidden" class="form-control form-control-sm" name="fname" id="" placeholder="Add Link" value="<?php echo $fname; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control form-control-sm" name="team">
                                            ...
                                            ?>
                                                <option value="<?php echo $show_team['team_name']; ?>"><?php echo $show_team['team_name']; ?></option>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="inputrole" name="emp" class="form-control form-control-sm" required>
                                            ...
                                            ?>
                                                <option value="<?php echo $show['fname']; ?>"><?php echo $show['fname']; ?></option>
                                            <?php $i++;
                                            }
                                            ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="link" id="" placeholder="Add Link" required autocomplete="off">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="startDate" class="required">Date</label>
                                        <input type="date" class="form-control form-control-sm" name="date" required autocomplete="off" min="<?php echo date('Y-m-d'); ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="dueDate" class="required">Meeting Time</label>
                                        <input type="time" class="form-control form-control-sm" name="time" required autocomplete="off">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputemail" class="form-label">Message</label>
                                        <textarea class="form-control form-control-sm" name="message" id="" cols="30" rows="3" required autocomplete="off"></textarea>
                                    </div>
                                    <center>
                                        <div class="col-md-6">
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($execute) {
                    ...
                    Swal.fire({
                        ...
                        window.location.replace('emp_meeting');
                    });
                </script>";
                } else {
